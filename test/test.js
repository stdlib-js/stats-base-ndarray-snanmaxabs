...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof snanmaxabs, 'function', 'main export is a function' );
	t.end();
});

tape( 'the function has an arity of 1', function test( t ) {
	t.strictEqual( snanmaxabs.length, 1, 'has expected arity' );
	t.end();
});
